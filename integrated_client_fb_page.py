...
controller_params = {
    "force_ctrl_damping": 60.0, # 200, 180, 90, 60 #compliacen velicty = this times the force
    ...
    try:
        ...
        try:
            for i in range(0,num_segments):
                ...
                #smooth out the path
                #smapling frequency speed to read the points
                #path are points without time stamp
                #trajectory is a path with associated time stamp
                #velocity we want to achieved and associated acceleartion
                #then achieve that velocity and then maintain it, afteewards we decreease the speed
                #### motion start ###
